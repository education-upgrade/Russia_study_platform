...
export const russiaCourseUnits: SubjectCourseUnit[] = [
  {
    unitNumber: 1,
    ...
    yearGroup: 'Y12',
    status: 'ready',
    pathwaySlugs: ['russia-1855', 'crimean-war', 'power-ideology-control', 'why-serfdom-had-to-end', 'emancipation-serfs', 'alexander-ii-wider-reforms', 'reform-preserve-autocracy', 'essay-skills-alexander-ii'],
  },
  {
    unitNumber: 2,
    ...
    yearGroup: 'Y12',
    status: 'building',
    pathwaySlugs: ['later-alexander-ii', 'alexander-iii-autocracy', 'counter-reform-practice', 'russification-minorities', 'ideas-challenged-tsarism', 'radical-opposition', 'ao3-reform-reaction-opposition'],
  },
  {
    unitNumber: 3,
...
export function getRussiaCourseUnit(unitNumber: number) {
  return russiaCourseUnits.find((unit) => unit.unitNumber === unitNumber) ?? null;
}
