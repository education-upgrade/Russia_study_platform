...
export default async function ClassTrackingPage({ params, searchParams }: { params: Promise<{ classId: string }>; searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  return <main className={styles.page}>
    <section className={styles.header}>
      ...
      <div className={styles.actions}><a className={styles.secondary} href={`/api/teacher/classes/${classId}/tracking.csv?format=detail`}>Download detailed CSV</a><a className={styles.primary} href={`/api/teacher/classes/${classId}/tracking.csv?format=matrix`}>Download matrix CSV</a></div>
    </section>

    <section className={styles.metrics}>
      <article><span>Assigned records</span><strong>{totalAssigned}</strong></article>
