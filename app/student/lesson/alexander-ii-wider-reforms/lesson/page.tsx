...
import { alexanderIIWiderReformsPathwaySlug, pathwayAlexanderIIWiderReformsLessonSections } from '@/lib/pathwayAlexanderIIWiderReformsContent';
...
async function getActivity() {
  ...
  if (lessonError || !lesson) return { activity: null, error: lessonError?.message ?? 'Alexander II wider reforms lesson not found.', enquiry: null };
